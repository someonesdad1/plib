...
birthdays = {
    "11 Feb": [["Parent"], "Grandmommie"],
    "17 Feb": [["In-law"], "Bill"],
    "19 Feb": [["In-law"], "Trink"],
    "14 Mar": [["Grandchild"], "Olivia"],
    "18 Apr": [["In-law"], "Joe"],
    "2 Jun": [["Spouse"], "Glenda"],
    "12 Jul": [["Grandchild"], "Jonas"],
    "25 Jul": [["Pet"], "Sweetums", "Cookie", "Col. Mustard"],
    "26 Jul": [["In-law", "Pet"], "Annette", "Mugsy"],
    "31 Aug": [["Child"], "Sally"],
    "5 Sep": [["Grandchild"], "Sara"],
    "29 Sep": [["Child"], "Jimmy"],
    "5 Oct": [["Grandchild"], "Victoria"],
    "16 Oct": [["Child"], "Mindi"],
    "19 Oct": [["Parent"], "Grandpa"],
    "5 Nov": [["Sibling"], "Debbie"],
    "16 Dec": [["In-law"], "Ginger"],
}
...
def PrintDay(x, y, day, month, width, height, day_fill_color, box_fill_color):
    ...
    if 0 and birthday in birthdays:
        push()
