...
255   0 255	Magenta
143   0  82	Maroon
  0 147 143	MediumAquamarine
 50  50 204	MediumBlue
 50 129  75	MediumForestGreen
209 193 102	MediumGoldenrod
189  82 189	MediumOrchid
...
137 104 205	MediumPurple3
 ...
 52 119 102	MediumSeaGreen
106 106 141	MediumSlateBlue
 35 142  35	MediumSpringGreen
  0 210 210	MediumTurquoise
213  32 121	MediumVioletRed
...
112 128 144	SlateGrey
 65 172  65	SpringGreen
  0 255 127	SpringGreen1
  0 238 118	SpringGreen2
  0 205 102	SpringGreen3
  0 139  69	SpringGreen4
 84 112 170	SteelBlue
...
for i, line in enumerate(data.split("\n")):
    ...
    name = name.strip()
    r, g, b = [int(i) for i in colors.split()]
