...
if 1:   # Names of colors
    # Define various classes that encapsulate sets of color names, translating
    # them to ANSI escape sequences.  The CN class is what will be used by the
    # module; you'll want to define intermdiate classes as needed to get the
    # support you want for your terminal.
    class AbstractCN:
        def __init__(self):
            pass
        def _default(self):
            'Sets self.n to the default color'
            raise RuntimeError("Abstract base class")
        def _check(self, name):
            'Make sure name is in dictionary'
            raise RuntimeError("Abstract base class")
        def fg(self, s):
    ...
    class CN(BaseCN):
        def __init__(self):
            ...
            self._default()
        def _default(self):
            '''Sets self.n to the default color.  This is specific to my terminal
            defaults, which is mintty.
            '''
...
if 1:   # Class definitions
    ...
    class Clr:
        ...
        def reset(self):
            ...
            self._cn = CN()    # Get color info for color names
