'''
ToDo
    - Use color.py to color code the output data
        - Function return type:  e.g. int: seal, flt: whtl, cpx: yel
    - Use flt.engsi to print out the execution time
        - Color could be for time units
            - ns royl
            - μs grnl
            - ms redl
...
Print execution time of some math operations
    ...
    repeatable results and not take too long to execute.
        ...
        in 2016, it took 5 s in 2021; 2.1 s in 2026.
...
if 0:
    ...
    '''
    # Results 19 Jan 2026 python 3.11.5 under WSL
    '''
            Python performance measures Mon Jan 19 14:08:03 2026
            -----------------------------------------------------
                                log10(N) = 5
                                                                            Time
    Operation               Expression                                     in ns
    ...
    Integer addition        3 + 4                                              5
    Integer subtraction     3 - 4                                              5
    Integer multiplication  3*4                                                8
    Integer division        3//4                                               6
    Long addition           30000000000000000 + 40000000000000000              5
    Long subtraction        30000000000000000 - 40000000000000000              5
    Long multiplication     30000000000000000*40000000000000000                6
    Long division           30000000000000000//40000000000000000               6
    Float addition          3. + 4.                                            5
    Float subtraction       3. - 4.                                            6
    Float multiplication    3.*4.                                              5
    Float division          3./4.                                              5
    Complex addition        (1. + 2.j) + (3. + 4.j)                            6
    Complex subtraction     (1. + 2.j) - (3. + 4.j)                            5
    Complex multiplication  (1. + 2.j)*(3. + 4.j)                              5
    Complex division        (1. + 2.j)/(3. + 4.j)                              5
    ...
    atanh                   atan(1.)                                          43
    fabs                    fabs(-1.2)                                        23
    factorial(10)           factorial(10)                                     24
    factorial(100)          factorial(100)                                   520
    floor                   floor(-1.2)                                       20
    fmod                    fmod(10.1, 0.2)                                   30
    frexp                   frexp(10.1)                                       58
    ldexp                   ldexp(10.1, 2)                                    28
    modf                    modf(10.1)                                        55
    trunc                   trunc(10.1)                                       17
    exp                     exp(10.1)                                         26
    log                     log(10.1)                                         65
    ...
    pow                     pow(10.1, 2)                                      58
    sqrt                    sqrt(10.1)                                        23
    degrees                 degrees(10.1)                                     18
    radians                 radians(10.1)                                     16
    ...
    mpmath functions (N//100)
    sqrt                    sqrt(mpf(1.))                                  1,600
    sqrt                    sqrt(mpc(1.j))                                 6,500
    hypot                   hypot(mpf(1.), mpf(2.))                        4,400
    exp                     exp(mpf(1.))                                   3,600
    exp                     exp(mpc(1.j))                                  6,100
    ln                      ln(mpf(11.))                                   3,200
    ln                      ln(mpc(11.j))                                  6,700
    log10                   log10(mpf(11.))                                8,500
    log10                   log10(mpc(11.j))                              14,000

    sin                     sin(mpf(1.))                                   3,600
    sin                     sin(mpc(1.j))                                  6,200
    cos                     cos(mpf(1.))                                   3,500
    cos                     cos(mpc(1.j))                                  6,500
    tan                     tan(mpf(1.))                                   4,900
    tan                     tan(mpc(1.j))                                  6,000
    asin                    asin(mpf(1.))                                  5,900
    asin                    asin(mpc(1.j))                                24,000
    acos                    acos(mpf(1.))                                  3,100
    acos                    acos(mpc(1.j))                                29,000
    atan                    atan(mpf(1.))                                  3,500
    atan                    atan(mpc(1.j))                                 7,800
    sinh                    sinh(mpf(1.))                                  4,400
    sinh                    sinh(mpc(1.j))                                 5,500
    cosh                    cosh(mpf(1.))                                  4,600
    cosh                    cosh(mpc(1.j))                                 5,600
    tanh                    tanh(mpf(1.))                                  4,000
    tanh                    tanh(mpc(1.j))                                 7,700
    asinh                   asinh(mpf(1.))                                 5,800
    asinh                   asinh(mpc(1.j))                                8,200
    acosh                   acosh(mpf(1.))                                 2,500
    acosh                   acosh(mpc(1.j))                               33,000
    atanh                   atanh(mpf(1.))                                 1,800
    atanh                   atanh(mpc(1.j))                               23,000
    sinc                    sinc(mpf(1.))                                  9,500
    sincpi                  sincpi(mpf(1.))                                6,800
    degrees                 degrees(mpf(1.))                               3,300
    radians                 radians(mpf(1.))                               3,900

    factorial               factorial(10)                                  1,400
    factorial               factorial(100)                                 1,500
    factorial               factorial(1000)                               13,000
    factorial               factorial(100000)                             14,000
    gamma                   gamma(mpf(100))                                1,600
    loggamma                loggamma(mpf(100))                             4,200
    beta                    beta(10, 11)                                  13,000
    harmonic                harmonic(mpf(10))                             16,000
    harmonic                harmonic(mpf(100))                            12,000
    harmonic                harmonic(mpc(10j))                           170,000
    harmonic                harmonic(mpc(100j))                          120,000
    incomplete gamma        gammainc(10, 1, 2)                           160,000
    incomplete gamma        gammainc(100, 1, 2)                          180,000
    exponential integral    ei(mpf(10))                                   17,000
    exponential integral    ei(mpf(100))                                   8,900
    logarithmic integral    li(mpf(10))                                   21,000
    logarithmic integral    li(mpf(100))                                  23,000
    error function          erf(mpf(10))                                   1,800
    inverse error function  erfinv(mpf(0.1))                             170,000

    Bessel function 1       besselj(10, mpf(2))                            7,000
    Bessel function 2       bessely(10, mpf(2))                          290,000
    Legendre                legendre(10, mpf(2))                          27,000
    zeta                    zeta(10)                                       2,100
    zeta                    zeta(mpc(10j))                               250,000
    ...
    flags                             sys.flags(debug=0, inspect=0, interactive=0, optimize=0, dont_write_bytecode=1, no_user_site=0, no_site=0, ignore_environment=0, verbose=0, bytes_warning=0, quiet=0, hash_randomization=1, isolated=0, dev_mode=False, utf8_mode=1, warn_default_encoding=0, safe_path=False, int_max_str_digits=-1)
