...
if 1:  # Header
    ...
    if 1:  # Global variables
        ...
        # coefficients came from https://srdata.nist.gov/its90/main/.
        # Click on the "Download tables" link, then click on the
        # "Coefficients of All Thermocouple Types", which is
        # https://srdata.nist.gov/its90/download/allcoeff.tab for the text
        # file of all the coefficients.
        nist_tc_forward = {
            # Polynomials for E(t)
            "B": (
                (
...
if __name__ == "__main__":
    d = {  # Options dictionary
        ...
        "deg_scale": "C",  # Degree scale
        "-d": False,  # Abbreviated type K table
        "-t": False,  # Perform self tests
    }
    _ParseCommandLine(d)
    _Temperature(d)
    print()
