...
Performs ideal gas law calculations.  Prompts you for input.
    ...
    Symbols used (all units internally will be SI):
        ...
        Vm = molar volume = V/n, m³/mol
        v = Vm = molar volume = V/n, m³/mol
        rho = density, kg/m³
    ...
    Note the left-hand side of the ideal gas law has units Pa*m³/mol,
...
def Help(d):
    ...
    Usage:  {sys.argv[0]}
      ...
      will be given an SI unit (Pa for pressure, m³ for volume, kg for mass, and
      K for temperature).
