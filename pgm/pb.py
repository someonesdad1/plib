...
def Usage(d, status=1):
    ...
    Usage:  {sys.argv[0]} temp c_or_f
      Print out a table of the voltage of a lead-acid battery at various
      temperatures.  Use c for °C and f for degrees °F.  Allow half a day for
