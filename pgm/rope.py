...
ToDo:
    ...
    - Samson 3/8" stable braid has min 4.8 klbf breaking with a mean of 5.6
      klbf, so mean is about 15% more than minimum.  Assuming a normal
...
if 1:  # Generic data
    ...
    def PrintGenericTable(data):
        ...
        if 1:  # Table in klbf
            ...
            print(f"  Strength in klbf and diameter in inches")
