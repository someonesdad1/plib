...
if 1:  # Header
    ...
    if 1:  # Global variables
        ...
        g.dbg = True
        ii = isinstance
        # Dictionaries to map digits to superscripts and subscripts
        g.digits = list(string.digits)
        g.superscripts = list("⁰¹²³⁴⁵⁶⁷⁸⁹")
        g.subscripts = list("₀₁₂₃₄₅₆₇₈₉")
        g.sup = dict(zip(g.digits, g.superscripts))
...
if 1:  # Data
    g.data = (
        ...
        (
            "Alizarin black",
            "Naphtharazine, 5,8-dihydroxy-1,4-naphthoquinone, a black dye",
            "C10H6O4",
        ),
        ("Alizarin blue", "A dihydroxyanthraquinone quinoline", "C17H9O4"),
        (
            "Alizarin bordeaux",
            "1,2,3-trihydroxyanthraquinone, a dye derived from anthraquinone",
            "C14H8O5",
        ),
        (
            "Alizarin brown",
        ...
        (
            "Alizarin red",
            "Alizarin sodium sulfonate; an acid-base indicator",
            "NaC14H7O7S",
        ),
        (
            "Alizarin yellow",
            "Sodium p-nitraniline salicylate, an acid-base indicator",
            "C13H10NO5",
        ),
        ...
        ("Black silver", "Stephanite, a silver antimony sulfide mineral", "Ag5Sb2S4"),
        ...
        (
            "Cobalt blue",
            "Pigment containing CoO, Zn), and chalcedony, an amorphous quartz, SiO2",
            "",
        ),
        ("Cobalt green", "Pigment, solid solution of CoO and ZnO", ""),
        ("Cobalt red", "Erythrite, a native cobalt arsenate", "Co3(AsO4)2· 8H2O"),
        (
            "Cobalt violet",
            "Cobalt phosphate, a pigment in oil paints",
            "Co3(PO4)2 ·2H2O",
        ),
        ...
        (
            "Cream of tartar",
            "Potassium bitartrate purified into small white crystals",
            "KHC4H4O6",
        ),
        ...
        (
            "Ethyl gas",
            "Leaded gasoline (i.e., includes tetraethyllead (C2H5)4Pb as an additive)",
            "",
        ),
        ...
        ("Javelle water", "Sodium hypochlorite", "NaOCl + H2O"),
        (
            "Jeweler's etchant",
            "3 g silver nitrate + 3 g nitric acid + 3 g mercurous nitrate + 100 cc H2O",
            "HgNO3·H2O + AgNO3 + HNO3 + H2O",
        ),
        ("Jeweler's rouge", "Ferric oxide", "Fe2O3"),
        ("K.N.S. solution", "10 g NH4CO3·H2O + 20 g (NH4)2S2O8 + 200 cc NH4OH", ""),
        ("Kalium", "Potassium", "K"),
        ...
        ("Metanil yellow", "Acid-base indicator", "C12H10N3O3SNa"),
        ("Methanol", "Methyl alcohol", "CH3OH"),
        (
            "Methyl green",
            "A triphyenylmethane dye and acid-base indicator",
            "C25H30N3Cl",
        ),
        ("Methyl orange", "Acid-base indicator", "C14H14O3N3SNa"),
        ("Methyl red", "Acid-base indicator", "C15H15O2N3"),
        ("Methylated spirits", "Methyl alcohol", "CH3OH"),
        ("Methylene blue", "Acid-base indicator", "C16H18N3SCl·3H2O"),
        ...
        (
            "Millon's base",
            "Solution of mercuric oxide in ammonium chloride",
            "(HOHg)2NH2OH",
        ),
        ("Mineral alkali, common", "Hydrated sodium carbonate", ""),
        (
            "Mineral dye blue",
            "A blue copper or tungsten ore, or a mixture of ferriferrocyanide, Fe4[Fe(CN)6]3, with calcium or barium sulfate",
            "",
        ),
        ...
        (
            "Neutral red",
            "Dimethyldiaminotoluphenazine hydrochloride, an acid-base indicator",
            "",
        ),
        ...
        (
            "Nordhausen acid",
            "Fuming sulfuric acid; SO3 in 98% sulfuric acid",
            "H2SO4 + SO3",
        ),
        ...
        ("Oleum", "Fuming sulfuric acid; SO3 in 98% sulfuric acid", "H2SO4 + SO3"),
        ...
        ("Plumbago", "Litharge, galena, or graphite", ""),
        ...
        (
            "Racemic acid",
            "An optically inactive form of tartaric acid consisting of equal quantities of optical isomers",
            "",
        ),
        ("Radium A", "218Po, 𝝺 = 3 minutes", ""),
        (
            "Radium C",
            "214Bi, 𝝺 = 20 minutes; 214Po (C'); C2 210Tl, 𝝺 = 1.3 minutes",
            "",
        ),
        ("Radium D", "210Pb, 𝝺 = 21 years", ""),
        ("Radium E", "210Bi", ""),
        ("Radium F", "210Po, 𝝺 = 140 days", ""),
        ("Radium G", "206Pb", ""),
        ...
        (
            "Reinecke's salt",
            "An ammonium salt of Reinecke's acid",
        ...
        (
            "Saleratus",
            "Potassium hydrogen carbonate or sodium bicarbonate",
            "KHCO3 or NaHCO3",
        ),
        ...
        (
            "Schöllkopf's acid",
            "One of 1-naphthol-4,8-disulfonic acid, 1-naphthylamine-4,8-disulfonic acid, and 1-naphthylamine-8-sulfonic acid",
            "",
        ),
        ...
        (
            ...
            "Ethyl nitrite solution with ethyl alcohol",
            "C2H5NO2 + C2H5OH",
        ),
        ...
        ("Thorium A", "216Po, 𝝺 = 150 ms", ""),
        ("Thorium C", "212Bi, 𝝺 = 61 minutes; C' is 212Po, 𝝺 = 300 ns.", ""),
        ("Thorium D", "208Tl, 𝝺 = 3 minutes", ""),
        ("Thorium X", "224Ra, 𝝺 = 3.6 days", ""),
        ...
        (
            "Tyrian purple",
            "6,6'-dibromoindigotin, a dye of the ancient Mediterranean",
            "C16H8N2O2Br2",
        ),
        ("Uranic ochre", "Uraconite, a yellow uranium oxide", "U2O3"),
        ("Uranium I", "238U", ""),
        ("Uranium II", "234U, 𝝺 = 2.5·10^5 years", ""),
        ("Uranium X", "X1 = 234Th, = 24 days, X2 = 234Pa", ""),
        (
            "Uranium yellow",
            "Sodium uranate, a pigment used in glass and ceramics",
            "Na2UO4",
        ),
        ...
        (
            "Vitamin B",
            "A group of water-soluble compounds that typically serve as co-enzymes",
            "",
        ),
        ...
        ("Vitamin D", "Fat-soluble vitamin steroid derivatives", ""),
        (
            "Vitamin E",
            "This vitamin occurs in four naturally occurring forms, called α-, β-, γ-, and δ-tocopherol. The α form, C29H50O2, has the greatest activity; the β- and γ- forms have one fewer methyl group, and the δ- form two fewer.",
            "",
        ),
        ("Vitriol", "A sulfate", ""),
        ...
        (
            "Whitewash",
            "Solution of quick lime or slaked lime used as a cheap substitute for paint.",
            "...",
        ),
...
if 1:  # Utility
    ...
    def Usage(status=1):
        ...
        Usage:  {sys.argv[0]} [options] [regex1 [regex2...]]
          Search for chemical names containing the indicated regular
          expressions.  The basic table is to relate old chemical names to
          modern names and chemical formulas.  All fields are searched
    ...
    def ParseCommandLine(d):
        ...
        d["-2"] = False  # Search new name
        d["-3"] = False  # Search formula
        d["-a"] = False  # Dump all records
        d["-i"] = True  # Ignore case
        if len(sys.argv) < 2:
            Usage()
        try:
            opts, args = getopt.getopt(sys.argv[1:], "123ahi")
...
if 1:  # Core functionality
    ...
    def Search(regex):
        ...
        Dbg(f"Searching for {regex!r}")
        if 0:
            # Search with regex
            for n, item in enumerate(g.data):
                if n < 2:  # Ignore first two items
                    continue
                old, new, formula = item
                found = False
                if d["-1"]:
                    mo = r.search(old)
                    found = mo if mo else False
                if not found and d["-2"]:
                    mo = r.search(new)
                    found = mo if mo else False
                if d["-3"]:
                    mo = r.search(formula)
...
if 0:
    ...
    for n, item in enumerate(g.data):
        ...
        if 0:
            c1 = max(c1, len(old))
            c2 = max(c2, len(new))
            c3 = max(c3, len(formula))
        else:
            c1.add(len(old))
            c2.add(len(new))
            c3.add(len(formula))
    print(f"old     {' '.join(str(i) for i in sorted(c1))}")
    print(f"new     {' '.join(str(i) for i in sorted(c2))}")
    print(f"formula {' '.join(str(i) for i in sorted(c3))}")
    exit()
if 0:
    # Develop a formula translator that will convert to Unicode format
    def TranslateFormula(old, descr, formula):
        """Convert an ASCII formula (there are a few Unicode characters in
        ...
        * in DDT and ethylene dichloride:  reset to char True
        ...
        chars = set(string.ascii_letters + "· é öα β γ δ")
        last = ""  # Keep track of last character
    ...
    for line in g.data:
        ...
        if len(f) == 2:
            f.append("")
        old, descr, formula = [i.strip() for i in f]
        # uformula = TranslateFormula(old, descr, formula)
        # print(f"{formula:{w}s} {uformula:{w}s}")
        # if formula.find("((") != -1:
        #    print(formula)
