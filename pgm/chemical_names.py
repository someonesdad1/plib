...
if 1:   # Data
    ...
    g.data = (
        ...
        ('Vitamin E', 'This vitamin occurs in four naturally occuring forms, called α-, β-, γ-, and δ-tocopherol. The α form, C29H50O2, has the greatest activity; the β- and γ- forms have one fewer methyl group, and the δ- form two fewer.', ''),
        ('Vitriol', 'A sulfate', ''),
