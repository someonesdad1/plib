...
if 1:   # Data
    g.data = (
        ...
        ('Alizarin red', 'Alizarin sodium sulfonate; an acid-base indicator', 'NaC14H7O7S'),
        ...
        ('Cobalt blue', 'Pigment containing CoO, Zn), and chalcedony, an amorphous quartz, SiO2', ''),
        ...
        ("Millon's base", 'Solution of mercuric oxide in ammonium chloride', '(HOHg)2NH2OH'),
        ...
        ('Nitrous ether', 'Ethyl nitrite', 'C2H5NO2'),
        ('Nordhausen acid', 'Fuming sulfuric acid; SO3 in 98% sulfuric acid', 'H2SO4 + SO3'),
        ...
        ('Prussian blue', 'iron(II) sulfate, FeSO4, and potassium ferrocyanide, K4Fe(CN)6', 'Fe7(CN)18(H2O)x where 14 <= x <= 16'),
        ...
        ('Radium C', "214Bi, 𝝺 = 20 minutes; 214Po (C'); C2 210Tl, 𝝺 = 1.3 minutes", ''),
        ...
        ("Schöllkopf's acid", 'One of 1-naphthol-4,8-disulfonic acid, 1-naphthylamine-4,8-disulfonic acid, and 1-naphthylamine-8-sulfonic acid', ''),
        ...
        ("Spencer's acid", '3 g AgNO3 + 3 g HNO3 + 3 g HgNO3·H2O + 100 cc', 'HgNO3·H2O + AgNO3 + HNO3 + H2O'),
        ...
        ('Vitamin B', 'A group of water-soluble compounds that typically serve as co-enzymes', ''),
        ...
        ('Vitamin E', 'This vitamin occurs in four naturally occurring forms, called α-, β-, γ-, and δ-tocopherol. The α form, C29H50O2, has the greatest activity; the β- and γ- forms have one fewer methyl group, and the δ- form two fewer.', ''),
        ('Vitriol', 'A sulfate', ''),
