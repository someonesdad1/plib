...
Examples:
    ...
    3.  I have a piece of 2" steel pipe that has an ID of 2.07 inches.  If a US dollar
        ...
        hold the ends of the bills together; this would add to the thickness, reducing
        the number of bills in the roll.  Finally, bills that had been crumpled probably
        wouldn't lie quite as flat as new bills.  I would thus probably reduce the
