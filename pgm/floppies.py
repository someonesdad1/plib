...
if 1:  # Header
    ...
    floppies = '''
        245 246 261 262 263 268 269 270 271 275 288 293 294 295 304 304a 305 305a 306
        307 308 309 310 311 312 319 320 321 322b 323 324 325 334 347 353 355 356 357 358
        359 360 361 362 363 364 365 370 371 374 375 376 377 378 379 380 401 402 407 408
        409 410 411 412 413 414 415 416 417 418 422 423 424 425 427 428 429 430 431 432
        433 434 435 436 437 438 439 441 442 445 446 447 448 449 450 451 452 456 457 458
        459 463 463a 464 465 466 467 468 469 470 471 472 473 474 475 476 477 478 479 480
...
if 1:  # Utility
    ...
    def ParseCommandLine(d):
        ...
        if len(sys.argv) < 2:
            Usage()
        try:
            opts, args = getopt.getopt(sys.argv[1:], "hio", ["help"])
...
if __name__ == "__main__":
    ...
    for line in lines:
        for r in regexps:
            if re.search(r, line, re.I if d["-i"] else 0):
