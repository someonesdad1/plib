...
def Manpage():
    ...
    copper ({density} kg/m³) and its room temperature resistivity of {rho} nΩ·m (agreed
    ...
    [5] ECMA-287 gives table 5.2 that specifies allowable touch temperatures based on time
        of contact and material type.  Referenced here: https://www.boydcorp.com/resources
            /resource-center/blog/ 237-maximum-touch-temperature.html
