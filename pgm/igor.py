...
if 1:  # Utility
    ...
    Usage:  {name} [options] [file1 [file2...]]
      Turn the files' content into words that Igor would say.  Mostly, this is done by
      changing 's' characters into 'sh'.  Inspiration from Terry Pratchett's "Fifth
      Elephant" and other Discworld stories containing Igors.
    Options:
