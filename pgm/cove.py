...
if 1:  # Header
    ...
    if 1:  # Global variables
        ...
        Kerf_width = 3/32*in2mm     # Width of blade's kerf in mm
        X_width = 599.5             # X width of table saw top in mm
if 1:  # Utility
    ...
    def Usage(d, status=1):
        ...
        Usage:  {name}  [options]  width  height
          Prints the fence angle (with respect to the blade rotation axis) needed for a
          table saw to cut a cove of specified dimensions.  The input units are {units}
          unless you use the -m option.
         
          width is the width of the cove at the surface of the workpiece.  height is the
          depth of the cove (i.e., how high above the table you'll set the blade to make
    ...
    def ParseCommandLine(d):
        d["-d"] = Diameter      # Blade diameter in mm
        d["-i"] = False         # Include instructions for cutting cove
        d["-k"] = Kerf_width    # Kerf width in mm
