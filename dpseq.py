...
if 1:   # Core functionality
    def GetClosest(x, seq, is_sorted=False, key=None, distance=operator.sub):
        ...
        is_sorted
            ...
            is found and is used to return the corresponding element of seq.
        ...
        if is_sorted is None:
            ...
            except ValueError:  # minimum isn't in sequence
                if len(set(o)) == 1:    # Question is unresolvable
                    raise ValueError("Closest item is unresolvable")
                # Get the index of minimum in o, as this is the index of the closest value in seq
