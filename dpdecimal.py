...
'''
    ...
    print things out.
        ...
        were added to the class, calling the Decimal method (i.e., the superclass) and
        typecasting the result to a dec.  This was ultimately enabled by using the
        signatures gotten from help(Decimal).
